 ...
 <?php require_once('menu.php'); ?>
  ...
  <div id="tabs">
    <ul>
      ...
      <a href="participating.php"><li class="on">Participating</li></a>
    ...
    $qry="select events.* from joins left join events on joins.event_id=events.id where joins.join_user='$user_name'";
